...
function validateCap1Col1VsCap2Col2(values) {
    let errors = [];
    let rowMappings = [
        { cap1: "CAP1_R10_C1", cap2: "CAP2_R10_C2" },
        { cap1: "CAP1_R11_C1", cap2: "CAP2_R11_C2" },
        { cap1: "CAP1_R12_C1", cap2: "CAP2_R12_C2" },
        { cap1: "CAP1_R13_C1", cap2: "CAP2_R13_C2" },
        { cap1: "CAP1_R14_C1", cap2: "CAP2_R14_C2" },
        { cap1: "CAP1_R15_C1", cap2: "CAP2_R15_C2" },
        { cap1: "CAP1_R16_C1", cap2: "CAP2_R16_C2" },
        { cap1: "CAP1_R17_C1", cap2: "CAP2_R17_C2" },
        { cap1: "CAP1_R18_C1", cap2: "CAP2_R18_C2" },
        { cap1: "CAP1_R19_C1", cap2: "CAP2_R19_C2" }
        ...
        if (row.cap1) {
            ...
            if (cap1Value > cap2Value) {
                errors.push({
                    'fieldName': row.cap1,
                    'msg': Drupal.t(
                        `Cod eroare: 54-018, Cap I, Col. 1, Rând ${row.cap1.replace(/\D/g, '')} trebuie să fie ≤ Cap II, Col. 2, Rând ${row.cap2.replace(/\D/g, '')}. 
