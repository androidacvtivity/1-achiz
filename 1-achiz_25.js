...
webform.validators.achiz_1 = function (v, allowOverpass) {
    ...
    for (var i = 1; i <= 9; i++) {
        ...
        if (r110 < r111_113) {
            webform.errors.push({
                ...
                'weight': 1,
                'msg': Drupal.t('Cod eroare: 54-010 Cap II Rind 110 >= rind 111 + rind 112 + rind 113 pe coloana @col -  @r110 < @r111_113', { '@col': i, '@r110': r110, '@r111_113': r111_113 })
            });
        }
    }
    ...
    for (var i = 1; i <= 8; i++) {
        ...
        var r19 = 0;
        r19 = Number(values["CAP1_R19_C" + i]);
        ...
        if (r10 < r11_19) {
            webform.errors.push({
                ...
                'weight': 1,
                'msg': Drupal.t('Cod eroare: 54-001 Cap I Rind10 >= rind 11+ rind 14 + rind 15 +rind16 + rind17 + rind18 + rind19 pe coloana  @col -  @r10 < @r11_19 ', { '@col': i,
                    '@r10': r10, '@r11_19': r11_19,
})
            });
        }
    }
