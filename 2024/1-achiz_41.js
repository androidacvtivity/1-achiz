...
webform.validators.achiz_1 = function (v, allowOverpass) {
    ...
    // Call the validation function for 54-018
    const cap1Cap2Errors = validateCap1Col1VsCap2Col2(values);

    // Push errors into webform if validation fails
    if (cap1Cap2Errors) {
        cap1Cap2Errors.forEach(error => webform.errors.push(error));
    }
...
function validateCap1Col1VsCap2Col2(values) {
    let errors = [];

    let rowMappings = [
        { cap1: "CAP1_R10_C1", cap2: "CAP2_R10_C2", rowLabel1: "10", rowLabel2: "10" },
        { cap1: "CAP1_R11_C1", cap2: "CAP2_R11_C2", rowLabel1: "11", rowLabel2: "11" },
        { cap1: "CAP1_R12_C1", cap2: "CAP2_R12_C2", rowLabel1: "12", rowLabel2: "12" },
        { cap1: "CAP1_R13_C1", cap2: "CAP2_R13_C2", rowLabel1: "13", rowLabel2: "13" },
        { cap1: "CAP1_R14_C1", cap2: "CAP2_R14_C2", rowLabel1: "14", rowLabel2: "14" },
        { cap1: "CAP1_R15_C1", cap2: "CAP2_R15_C2", rowLabel1: "15", rowLabel2: "15" },
        { cap1: "CAP1_R16_C1", cap2: "CAP2_R16_C2", rowLabel1: "16", rowLabel2: "16" },
        { cap1: "CAP1_R17_C1", cap2: "CAP2_R17_C2", rowLabel1: "17", rowLabel2: "17" },
        { cap1: "CAP1_R18_C1", cap2: "CAP2_R18_C2", rowLabel1: "18", rowLabel2: "18" },
        { cap1: "CAP1_R19_C1", cap2: "CAP2_R19_C2", rowLabel1: "19", rowLabel2: "19" }
       
    ];

    rowMappings.forEach(row => {
        if (row.cap1) {
            let cap1Value = isNaN(Number(values[row.cap1])) ? 0 : Number(values[row.cap1]);
            let cap2Value = isNaN(Number(values[row.cap2])) ? 0 : Number(values[row.cap2]);

            if (cap1Value > cap2Value) {
                errors.push({
                    'fieldName': row.cap1,
                    'msg': Drupal.t(
                        `Cod eroare: 54-018, Cap I, Col. 1, Rând ${row.rowLabel1} trebuie să fie ≤ Cap II, Col. 2, Rând ${row.rowLabel2}. 
                        Valoare actuală: ${cap1Value}, Valoare maximă permisă: ${cap2Value}`
                    )
                });
            }
        }
